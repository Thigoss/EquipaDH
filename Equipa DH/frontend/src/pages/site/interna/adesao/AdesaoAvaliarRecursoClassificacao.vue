  ...
  <span>
    <b-col md="12" sm="12">
      <b-card no-body>
        <b-card-body>
          <b-form>
            <h1 tabindex="0">Analisar Solicitação de Recurso de Habilitados e Classificados</h1>
            <b-row>
              <b-col md="4" sm="12">
              ...
              <b-row>
                <b-col md="12" sm="12">
                  <table aria-describedby="my-table" aria-rowcount="4" id="my-table" aria-busy="false" aria-colcount="7"
                    ...
                    <tbody v-if="recursoClassificacao && recursoClassificacao.arquivos.length > 0">
...
export default {
  ...
  mounted () {
    ...
    this.loadRecursoClassificacao(this.$route.params.id)
