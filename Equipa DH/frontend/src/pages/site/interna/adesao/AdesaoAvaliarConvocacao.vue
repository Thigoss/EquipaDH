  ...
  <span>
    <b-col md="12" sm="12">
      <b-card no-body>
        <b-card-body>
          <b-form>
            <h1 tabindex="0">Analisar Documento de Convocação</h1>
            <b-row>
              <b-col md="4" sm="12">
                  ...
                  <tbody>
                    <tr class="action">
                      ...
                      <td tabindex="0" style="width: 10%">
                        <b-button @click="$abrirDocumento('adesao_termo_convocacao', form.id)">
  ...
  methods: {
    ...
    load (id) {
      Vue.http.get('api/adesao/' + id).then(response => {
        ...
        this.form.termo_convocacao = data.termo_convocacao
