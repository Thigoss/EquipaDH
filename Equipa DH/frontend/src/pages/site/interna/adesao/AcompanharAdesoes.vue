    ...
    <b-overlay :show="overlay" rounded="sm">
      <b-card no-body>
        <b-card-header>
          <b-row>
            <b-col md="9">
              <h3 tabindex="0"><strong>Acompanhar Cronograma</strong></h3>
            </b-col>
          </b-row>
        </b-card-header>
        <b-card-body>
                    ...
                    <tr class="action" v-for="adesao in adesoes.data" :key="adesao.id">
                      ...
                      <td style="width: 1%; white-space: nowrap;">
                        <button v-if="can('adesao.historico')" class="btn btn-sm btn-secondary action"
                          title="Acompanhar Cronograma" @click="acompanharCronograma(adesao.cronograma_id, adesao.id)">
                ...
                <b-row>
                  <b-col cols="4">
                    <pagination-page tabindex="0" v-show="adesoes.data !== undefined" :totalPorPagina="totalPorPagina"
                      :resource="resource" :filtros="filtros" :origin="'MinhasAdesoes'"></pagination-page>
                  </b-col>
                </b-row>
              </span>
            </b-container>
