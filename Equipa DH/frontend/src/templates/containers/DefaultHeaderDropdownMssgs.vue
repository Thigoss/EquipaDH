  ...
  <AppHeaderDropdown right no-caret>
    ...
    <template slot="dropdown">
      <div class="dropdown-menu-lg">
        <b-dropdown-header tag="div" class="text-center"><strong>You have {{ itemsCount }}
            messages</strong></b-dropdown-header>
        <b-dropdown-item>
          <div class="message">
            ...
            <div class="text-truncate font-weight-bold"><span class="fa fa-exclamation text-danger"></span> Important
              message</div>
        ...
        <b-dropdown-item href="#">
          <div class="message">
            <div class="pt-3 mr-3 float-left">
              <div class="avatar">
                <img src="https://coreui.io/demo/img/avatars/6.jpg" class="img-avatar"
